...
class SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.push(context, PageTransition(type: PageTransitionType.fade, child:MappingPage(auth: Auth(),)));
      }
    });
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("The digital app for sharing your notes.", 
